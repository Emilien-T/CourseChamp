  ...
  public Vote(int aId, boolean aType, Student aStudent, Review aReview) {
    ...
    if (!setStudent(aStudent)) {
      throw new RuntimeException(
          "Unable to create Vote due to aStudent. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    if (!setReview(aReview)) {
      throw new RuntimeException(
          "Unable to create Vote due to aReview. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
