...
public class Review {
  ...
  public Review(int aId, int aRating, String aText, Student aStudent, CourseOffering aCourseOffering) {
    ...
    if (!setStudent(aStudent)) {
      throw new RuntimeException(
          "Unable to create Review due to aStudent. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    if (!setCourseOffering(aCourseOffering)) {
      throw new RuntimeException(
          "Unable to create Review due to aCourseOffering. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
  ...
  public String toString() {
    return super.toString() + "[" +
        ...
        "  " + "student = "
        + (getStudent() != null ? Integer.toHexString(System.identityHashCode(getStudent())) : "null")
        + System.getProperties().getProperty("line.separator") +
        "  " + "courseOffering = "
        + (getCourseOffering() != null ? Integer.toHexString(System.identityHashCode(getCourseOffering())) : "null");
  }
}