...
public class StudentService {
    ...
    /**
     * Service method to fetch an existing student with a specific email from the database
    ...
    public Student createStudentAccount(Student student) {
        if ((adminRepository.findAdminByEmail(student.getEmail()) == null) && (studentRepository.findStudentByEmail(student.getEmail()) == null))
