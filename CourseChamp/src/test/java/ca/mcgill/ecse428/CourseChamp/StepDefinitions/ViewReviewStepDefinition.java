...
public class ViewReviewStepDefinition {
    ...
    @When("the user selects the option to upvote the same review again")
    public void theUserSelectsOptionToRemoveDownvoteFromReview() {
        DummyRepo.SaveInSystem("removeDownvote");
    }
    //=-=-=-=-=-=-=-=-=-=-=-=- WHEN -=-=-=-=-=-=-=-=-=-=-=-=//
    ...
    public void theSystemShouldIncrementTheUpvoteCount() {
        // Assert the upvote action was saved. In a real scenario, check the updated review details.
    ...
    public void theSystemShouldDecrementTheUpvoteCount() {
        // Assert the remove upvote action was saved. In a real scenario, check the updated review details.
    ...
    public void theSystemShouldIncrementTheDownvoteCount() {
        // Assert the downvote action was saved. In a real scenario, check the updated review details.
    ...
    public void theSystemShouldDecrementTheDownvoteCount() {
        // Assert the remove downvote action was saved. In a real scenario, check the updated review details.
    ...
    public void theUserShouldSeeAMessageForNoReviews() {
        // Assert that the message for no reviews is displayed. This could be simulated by checking a flag in DummyRepo.
