...
public class CourseServiceTests {
    ...
    public void testCreateIncompleteDetailsCourse()
    {
        ...
        // when(CourseRepository.findCourseBycourseCode(department + course)).thenReturn(null);

        CourseChampException e = assertThrows(CourseChampException.class, () -> courseService.createCourse(invalidCourse));
    ...
    public void testInvalidCourseNumberTest()
    {
        ...
        final Course invalidCourse = new Course(department, invalidCourseNumber, name, "", "");

        when(courseRepository.findCourseByCourseCode(department + invalidCourseNumber)).thenReturn(null);
     ...
     public void testInvalidDepartmentTest() {
         ...
         assertEquals("Department must be a four-letter alphabetic string", e.getMessage());
     }
